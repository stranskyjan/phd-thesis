...
% Jan Elias: What about rotations? Are they assumed zero?
...
Constitutive law assumes independent normal and shear direction and thus resulting normal and shear forces are parallel to normal and shear relative displacements:
\begin{align}
...
\begin{itemize}
	\item
		...
		% Jan Elias: For N=1000, it is not always non-changing
	...
	\item
		...
		% Jan Elias: the case of non-convergence is not shown
